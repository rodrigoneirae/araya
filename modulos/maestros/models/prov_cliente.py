...
class Provclientes(models.Model):
    rut = models.CharField(db_column='RUT', primary_key=True, max_length=13)  # Field name made lowercase.
    dig_ver = models.CharField(db_column='DIG_VER', max_length=1, blank=True, null=True)  # Field name made lowercase.
    nombre = models.CharField(db_column='NOMBRE', max_length=50)  # Field name made lowercase.
    sigla = models.CharField(db_column='SIGLA', max_length=20, blank=True, null=True)  # Field name made lowercase.
    giro = models.CharField(db_column='GIRO', max_length=50, blank=True, null=True)  # Field name made lowercase.
    tipo = models.CharField(db_column='Tipo', max_length=12)  # Field name made lowercase.
    ...
    comuna = models.CharField(db_column='COMUNA', max_length=18, blank=True, null=True)  # Field name made lowercase.
    ciudad = models.CharField(db_column='CIUDAD', max_length=20, blank=True, null=True)  # Field name made lowercase.
    fono = models.CharField(db_column='FONO', max_length=20, blank=True, null=True)  # Field name made lowercase.
    ...
    emailcontacto = models.CharField(db_column='emailContacto', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ...
    over1 = models.CharField(db_column='OVER1', max_length=10, blank=True, null=True)  # Field name made lowercase.
    ult_com = models.DateTimeField(db_column='ULT_COM', blank=True, null=True)  # Field name made lowercase.
    rut_fac = models.CharField(db_column='RUT_FAC', max_length=20, blank=True, null=True)  # Field name made lowercase.
