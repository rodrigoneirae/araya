...
class Articulos(models.Model):
    ...
    um = models.CharField(db_column='UM', max_length=255)  # Field name made lowercase.
    ...
    proced = models.CharField(db_column='PROCED', max_length=255, blank=True, null=True)  # Field name made lowercase.
    bodega = models.CharField(db_column='Bodega', max_length=255, blank=True, null=True)  # Field name made lowercase.
    cupx = models.CharField(db_column='CUPX', max_length=255, blank=True, null=True)  # Field name made lowercase.
    cumax = models.CharField(db_column='CUMAX', max_length=255, blank=True, null=True)  # Field name made lowercase.
