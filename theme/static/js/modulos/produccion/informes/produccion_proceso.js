const urlProdProc = (document.currentScript?.dataset.url) || '/';
...
function generarInforme(formato) {
    if (formato === 'pdf') {
        _fetchInforme('generar_pdf', 'produccion_proceso.pdf');
    } else {
        _fetchInforme('generar_excel', 'produccion_proceso.xlsx');
    }
}
